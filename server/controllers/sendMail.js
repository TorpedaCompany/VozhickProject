...
module.exports = function(data, totalPrice) {
    ...
    server.send({
        ...
        function(err, message) {
            if (!err)
                logger.info("Сообщение на отправлено на почту");
